...
@push('styles')
<style>
    .aspek-table th, .aspek-table td { text-align: center; vertical-align: middle; }
    .aspek-table td:first-child { text-align: left; }
    .section-score { background-color: #e9ecef; font-weight: bold; }
    @media print {
        @page {
            size: 215mm 330mm;
            margin: 10mm;
        ...
        .mt-3 { margin-top: 2px !important; }
        .p-3 { padding: 5px !important; }
        .alert { display: none !important; }
        .row { margin: 0 !important; }
        .table-borderless th, .table-borderless td { padding: 1px 0 !important; }
        .keterangan-skala { font-size: 8px !important; margin: 2px 0 !important; }
        .page-one-content { page-break-inside: avoid; }
        .kesimpulan-box {
