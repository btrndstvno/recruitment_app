...
@section('title', 'Isi Laporan Psikotest - ' . $applicant->nama_lengkap)
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-clipboard-plus me-2"></i>Laporan Psikotest</h2>
    <div class="d-flex gap-2 align-items-center">
        <div class="btn-group no-print" role="group" aria-label="Tipe Laporan">
            <a href="{{ route('psikotest.create', ['applicant' => $applicant, 'type' => '34']) }}" 
               class="btn {{ $reportType == '34' ? 'btn-primary' : 'btn-outline-primary' }}">
                34 Pertanyaan
            </a>
            <a href="{{ route('psikotest.create', ['applicant' => $applicant, 'type' => '38']) }}" 
...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('psikotest.store', $applicant) }}" method="POST" data-loading="true">
            @csrf
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control @error('iq_score') is-invalid @enderror" 
                           id="iq_score" name="iq_score" value="{{ old('iq_score') }}" >
                    @error('iq_score')
                ...
                <div class="col-md-5">
                    ...
                    <select class="form-select @error('iq_category') is-invalid @enderror" id="iq_category" name="iq_category">
                        ...
                        <option value="borderline" {{ old('iq_category') == 'borderline' ? 'selected' : '' }}>Borderline (70-79)</option>
                        <option value="dibawah_rata_rata" {{ old('iq_category') == 'dibawah_rata_rata' ? 'selected' : '' }}>Dibawah Rata-Rata (80-89)</option>
                        <option value="rata_rata" {{ old('iq_category') == 'rata_rata' ? 'selected' : '' }}>Rata-Rata (90-109)</option>
                        <option value="diatas_rata_rata" {{ old('iq_category') == 'diatas_rata_rata' ? 'selected' : '' }}>Diatas Rata-Rata (110-119)</option>
                        <option value="superior" {{ old('iq_category') == 'superior' ? 'selected' : '' }}>Superior (120-139)</option>
                        <option value="very_superior" {{ old('iq_category') == 'very_superior' ? 'selected' : '' }}>Very Superior (140-169)</option>
                    </select>
                    @error('iq_category')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <table class="table table-bordered aspek-table">
                    ...
                    <tbody>
                        ...
                        <tr class="section-score">
                            ...
                            <td class="text-center" id="xa_display">-</td>
                        </tr>
                        ...
                        <tr class="section-score">
                            ...
                            <td class="text-center" id="xb_display">-</td>
                        </tr>
                        ...
                        <tr class="section-score">
                            ...
                            <td class="text-center" id="xc_display">-</td>
                        </tr>

                        {{-- Total Score --}}
                        <tr class="table-dark">
                            <td colspan="6" class="text-end"><strong>XT (TOTAL)</strong></td>
                            <td class="text-center" id="xt_display"><strong>-</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="mb-4">
                <textarea class="form-control @error('kesimpulan_saran') is-invalid @enderror" 
                          ...
                          placeholder="Catatan tambahan disini.">{{ old('kesimpulan_saran') }}</textarea>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-success">
                    <i class="bi bi-save me-1"></i>Simpan Laporan Psikotest
                </button>
            </div>
        </form>
    </div>
