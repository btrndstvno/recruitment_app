                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-3 col-md-3 col-5">
                        ...
                        <select class="form-select" id="bulan" name="bulan" {{ request('tanggal') ? 'disabled' : '' }}>
                            ...
                            <option value="1" {{ request('bulan') == '2' ? 'selected' : '' }}>Febuari</option>
                            <option value="1" {{ request('bulan') == '3' ? 'selected' : '' }}>Maret</option>
                            <option value="1" {{ request('bulan') == '4' ? 'selected' : '' }}>April</option>
                            <option value="1" {{ request('bulan') == '5' ? 'selected' : '' }}>Mei</option>
                            <option value="1" {{ request('bulan') == '6' ? 'selected' : '' }}>Juni</option>
                            <option value="1" {{ request('bulan') == '7' ? 'selected' : '' }}>Juli</option>
                            <option value="1" {{ request('bulan') == '8' ? 'selected' : '' }}>Agustus</option>
                            <option value="1" {{ request('bulan') == '9' ? 'selected' : '' }}>September</option>
                            <option value="1" {{ request('bulan') == '10' ? 'selected' : '' }}>Oktober</option>
                            <option value="1" {{ request('bulan') == '11' ? 'selected' : '' }}>November</option>
                            <option value="1" {{ request('bulan') == '12' ? 'selected' : '' }}>Desember</option>
                        </select>
                    </div>
