...
@section('title', 'Tambah Pelamar - Recruitment App')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-person-plus me-2"></i>Tambah Pelamar Baru</h2>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('applicants.store') }}" method="POST" id="applicantForm" data-loading="true">
            @csrf
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('color_code') is-invalid @enderror" id="color_code" name="color_code">
                        ...
                        <option value="ungu" style="color:#000;" {{ old('color_code') == 'ungu' ? 'selected' : '' }}>🟪Ungu</option>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('no_hp_2') is-invalid @enderror" 
                           id="no_hp_2" name="no_hp_2" value="{{ old('no_hp_2') }}">
                    @error('no_hp_2')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_lamaran') is-invalid @enderror" 
                           id="tanggal_lamaran" name="tanggal_lamaran" value="{{ old('tanggal_lamaran', date('Y-m-d')) }}" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('pkl_awal') is-invalid @enderror" 
                               id="pkl_awal" name="pkl_awal" value="{{ old('pkl_awal') }}">
                        @error('pkl_awal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('pkl_akhir') is-invalid @enderror" 
                               id="pkl_akhir" name="pkl_akhir" value="{{ old('pkl_akhir') }}">
                        @error('pkl_akhir')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('pkl_asal_sekolah') is-invalid @enderror" 
                               id="pkl_asal_sekolah" name="pkl_asal_sekolah" value="{{ old('pkl_asal_sekolah') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('pkl_jurusan') is-invalid @enderror" 
                               id="pkl_jurusan" name="pkl_jurusan" value="{{ old('pkl_jurusan') }}">
                        @error('pkl_jurusan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control @error('pkl_tempat') is-invalid @enderror" 
                               id="pkl_tempat" name="pkl_tempat" value="{{ old('pkl_tempat') }}">
                        @error('pkl_tempat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control @error('catatan') is-invalid @enderror" 
                              ...
                              placeholder="Catatan tambahan disini.">{{ old('catatan') }}</textarea>
                    @error('catatan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-1"></i>Simpan Data Pelamar
                </button>
            </div>
        </form>
    </div>
