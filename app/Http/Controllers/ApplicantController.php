...
{
    /**
     * Export selected applicants (by IDs from request)
     */
    public function exportSelected(Request $request)
    {
        ...
        // Ambil data applicant sesuai ID yang dipilih
        ...
        if (class_exists('Maatwebsite\\Excel\\Facades\\Excel') && class_exists('App\\Exports\\ApplicantsExport')) {
            return \Maatwebsite\Excel\Facades\Excel::download(new \App\Exports\ApplicantsExport($applicants), 'selected_applicants.xlsx');
        }
        ...
        $columns = [
            ...
            'tempat_lahir', 'tanggal_lahir', 'gender', 'umur', 'tanggal_lamaran', 'tanggal_test', 'nama_sekolah',
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'umur' => 'required|string|in:0-17,18-25,26-35,36-45,46-55,56+',
